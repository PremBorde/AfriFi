...
import { ENTRYPOINT, SMART_ACCOUNT_FACTORY, VAULT_ADDRESS, factoryAbi, smartAccountAbi, vaultAbi } from "../../lib/dex/contracts";
import { buildUserOp, hashUserOp } from "../../lib/dex/userOp";
import { pollOrderStatus, submitUserOp } from "../../lib/dex/injective";
...
export function useUserOp() {
    ...
    async function submitTrade(params: {
        ...
        try {
            ...
            const digest = hashUserOp(userOp, ENTRYPOINT, Number(process.env.NEXT_PUBLIC_CHAIN_ID || 2424));

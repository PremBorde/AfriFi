  ...
  return (
    <div className={clsx("relative inline-block", className)} id={id}>
      ...
      >
        ...
        <div className="ui-anim-txt-wrapper relative flex min-h-6 min-w-[6.4em] items-center">
          <div
            className={clsx(
          ...
          <div
            className={clsx("ui-anim-txt-2 absolute", generating ? "opacity-100" : "opacity-0")}
          >
